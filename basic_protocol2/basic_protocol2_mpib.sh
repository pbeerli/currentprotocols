...
nohup mpirun -np 9 --oversubscribe migrate-n-mpi  parmfile_model1b -nomenu > parm_model1b.log 2>parm_model1b.err
#
time=`date`
...
nohup mpirun -np 9 --oversubscribe migrate-n-mpi  parmfile_model2b -nomenu > parm_model2b.log 2> parm_model2b.err
#
time=`date`
...
nohup mpirun -np 9 --oversubscribe migrate-n-mpi  parmfile_model3b -nomenu > parm_model3b.log 2> parm_model3b.err
echo "Done"
